...
| PG-04 | Real PostgreSQL test harness and coverage gates | open | PostgreSQL 18 fixtures; 557-test full fast suite plus 2 PostgreSQL runtime-boundary tests pass; job/publication concurrency covered; final coverage thresholds pending |
