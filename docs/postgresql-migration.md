...
| PG-04 | Real PostgreSQL test harness and coverage gates | done | PostgreSQL 18 fixtures; 593 passed and 2 skipped; migration-critical coverage 83.53% (minimum 80%); job/publication concurrency covered |
...
| PG-11 | Full tests, coverage, concurrency, and performance gates pass | done | 593 passed, 2 skipped; 83.53% coverage; Ruff/architecture/TypeScript/build pass; restored DB revision/counts match. Live revision-0003 concurrent 50-request p95: status 282ms, `/today` 327ms, NVDA 470ms, portfolio 205ms; all responses 200. Local DB is 139MB versus 32GB while retaining compact durable raw facts |
| PG-12 | Canonical runtime cut over and live NVDA probe verified | done | `mini1.local` runs PostgreSQL revision `20260711_0003`; API and Vite bind all interfaces; `/api/status`, `/today`, portfolio, options radar, and `/api/tickers/NVDA` returned 200. Live custom backup `market-20260712T105041Z.dump` is 12.9MB with SHA-256 `fe0ea03ab108596421e5012376ec82458dea703d82e3e11fe05be1d233e19715` |
| PG-13 | Adversarial review has no accepted findings | open | Four high-effort passes completed and every accepted finding was repaired with a regression test. A fresh read-only review of the final remediation found three additional strategy-authority race/normalization invariants; they are pending Joe's review decision before remediation. Codex quota resets at 11:20 EDT and the installed Claude fallback has invalid local credentials |
