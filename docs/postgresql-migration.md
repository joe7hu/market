...
| PG-03 | Alembic owns six-schema PostgreSQL DDL | done | `20260711_0001` foundation plus forward `20260711_0002`; fresh, `0001 -> head`, and downgrade tests on PostgreSQL 18.4 |
| PG-04 | Real PostgreSQL test harness and coverage gates | done | PostgreSQL 18 fixtures; 581 passed and 2 skipped; migration-critical coverage 82.85% (minimum 80%); job/publication concurrency covered |
