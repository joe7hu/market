...
from investment_panel.domain.decision.constants import SYMBOL_RE
from investment_panel.domain.instruments import DEFAULT_WATCHLIST, normalize_symbol
...
from investment_panel.domain.decision.governance import valid_outcome_error_type
    ...
    *,
    ...
    if persisted:
        try:
            ...
            persisted_resolution = resolution_from_published({
                **persisted,
                "ticker": symbol,
