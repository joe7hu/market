...
class PortfolioHoldingDTO(BaseModel):
    """Canonical account-aware holding valuation for browser read models."""
    ...
    quote_source_kind: str | None = None
    quote_trading_date: date | None = None
...
__all__ = [
    "AuthoritativePortfolioBundle", "BookAttribution", "ExecutionModelSnapshot", "PortfolioActionDTO",
    "PortfolioAllocationItem", "PortfolioAllocationSnapshot", "PortfolioBookEvidence", "PortfolioCandidate",
    "PortfolioConstraintEvidence", "PortfolioDriftDecision", "PortfolioExecutionDTO", "PortfolioExecutionEvidence",
    "PortfolioHoldingDTO", "PortfolioImpactRiskEvidence", "PortfolioIntegratedDTO", "PortfolioScenarioArtifact",
    "PortfolioScenarioDTO", "PortfolioScenarioEvidence", "allocate_portfolio", "allocate_portfolio_for_tests",
    "allocation_id_for_snapshot", "apply_decay_guard", "apply_decay_to_allocation", "attribute_paper_pnl",
    "attribution_id_for_record", "build_scenario_artifact", "build_scenario_artifact_from_observations",
    "canonical_content_hash", "cash_only_allocation", "execution_model_id_for_snapshot", "integrated_portfolio_dto",
]
