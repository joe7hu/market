    ...
    if portfolio_rows:
        payload["portfolio_holdings"] = [
            PortfolioHoldingDTO.model_validate({
                ...
                "average_cost": row.get("avg_cost", row.get("average_cost")),
                "price": row.get("price"),
                ...
                "quote_available_at": row.get("quote_available_at"),
                "quote_source": row.get("quote_source"),
                "quote_source_kind": row.get("quote_source_kind"),
                "quote_trading_date": row.get("quote_trading_date"),
                "available_at": row.get("available_at"),
                "currency": row.get("currency") or "USD",
                "valuation_status": row.get("valuation_status") or "unavailable",
                "valuation_available": row.get("valuation_available", False),
                "next_step": row.get("next_step") or "Review sizing, thesis, and latest evidence.",
