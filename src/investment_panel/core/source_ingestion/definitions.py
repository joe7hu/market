...
SOURCE_DEFINITIONS = [
    ...
    },
    {
        ...
        "source_name": "Birdclaw primary X/Twitter",
        "source_family": "private_graph",
        "source_kind": "x_tweet_export",
        "origin": "market",
        "enabled": True,
        "ingestion_mode": "mounted_raw_export",
        "raw_access": "local_private",
        "source_url": "/Volumes/agent/data-sources/birdclaw-primary/exports",
        "notes": "Canonicalized Birdclaw tweet/bookmark/observation export. Arco-overlapped tweet items are retained but do not double-count ticker signals.",
    },
    {
        "source_id": "browser_primary_captures",
        "source_name": "Browser primary captures",
        "source_family": "private_graph",
        "source_kind": "browser_capture_export",
        "origin": "market",
        "enabled": True,
        "ingestion_mode": "mounted_raw_export",
        "raw_access": "local_private",
        "source_url": "/Volumes/agent/data-sources/browser-primary/captures",
        "notes": "Explicit Arco browser/page captures from the mounted raw export. Arco-overlapped pages are retained but do not double-count ticker signals.",
    },
    {
        "source_id": "odd_lots",
