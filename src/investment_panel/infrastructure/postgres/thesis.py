...
from investment_panel.infrastructure.postgres.thesis_evidence import assessments_by_revision, thesis_source_evidence
from investment_panel.infrastructure.postgres.thesis_monitor_universe import monitored_thesis_rows
