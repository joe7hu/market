...
from investment_panel.infrastructure.postgres.strategy_governance import paper_provenance_is_database_backed
from investment_panel.core.option_trade_ticket import TICKET_VERSION, execution_policy
from investment_panel.domain.decision import is_market_open, promotion_readiness
...
def _v3_paper_readiness(payload: dict[str, Any], evaluated_at: datetime) -> str:
    ...
    from investment_panel.infrastructure.postgres.options_publication import as_datetime
        ...
        *,
        ...
        with self.runtime.transaction() as connection:
            ...
            if experiment_publication_id is not None:
                from investment_panel.infrastructure.postgres.options_experiments import experiment_publication_row
            ...
            from investment_panel.infrastructure.postgres.options_publication import contract_readiness
