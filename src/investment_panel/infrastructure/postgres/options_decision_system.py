...
from investment_panel.domain.options.history_v3 import MODEL_REVISION, static_arbitrage_findings
...
from investment_panel.infrastructure.postgres.analysis import current_option_publication_result
from investment_panel.infrastructure.postgres.runtime import DatabaseRuntime
from investment_panel.infrastructure.postgres.options_journal import learning_progress, paper_journal, shadow_observations
from investment_panel.infrastructure.postgres.options_history_canary import canary_health
from investment_panel.infrastructure.postgres.options_decision_workspace import latest_run, workspace_payload
...
def _candidate_payload(value: dict[str, Any]) -> dict[str, Any]:
    ...
    if not strategy_route:
        from investment_panel.domain.strategies.routing import ROUTE_VERSION
