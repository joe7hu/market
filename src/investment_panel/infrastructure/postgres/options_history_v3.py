...
from investment_panel.domain.options.history_v3 import MODEL_REVISION, analyze_group
...
from investment_panel.infrastructure.postgres.opportunity_episodes import canonical_option_lane, option_episode_key, option_sample_eligibility, scorecard_truth_cohort
...
from investment_panel.infrastructure.postgres.options_history_policy import apply_publication_cap
from investment_panel.infrastructure.postgres.options_history_ticket import published_candidates
...
def surface_shift_run_summary(
    ...
    from investment_panel.infrastructure.postgres.options_distribution_shift import materialize_surface_shift
