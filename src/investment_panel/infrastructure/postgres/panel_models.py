...
from investment_panel.infrastructure.postgres.panel_queries import OWNED_CORRELATIONS_QUERY, build_query_policies
from investment_panel.infrastructure.postgres.panel_source_queries import SOURCE_QUERIES, SOURCE_UNIVERSE_QUERIES
from investment_panel.infrastructure.postgres.event_panel_models import EVENT_DIRECT_QUERIES
from investment_panel.infrastructure.postgres.portfolio_intelligence import portfolio_intelligence_tables
from investment_panel.infrastructure.postgres.thesis import thesis_monitor_rows, thesis_rows
...
from investment_panel.infrastructure.postgres.brokers import broker_status_rows
...
from investment_panel.infrastructure.postgres.panel_watchlist import TECHNICALS_QUERY, options_ticker_signal_rows, technical_rows
...
from investment_panel.infrastructure.postgres.current_quotes import current_quote_rows
from investment_panel.infrastructure.postgres.panel_option_queries import TRANSITION_QUERY, current_option_query, transition_rows
from investment_panel.infrastructure.postgres.superinvestor_portfolios import superinvestor_portfolios
from investment_panel.infrastructure.postgres.runtime import API_PROFILE, RuntimeProfile
...
def load_postgres_tables(
    ...
    *,
    ...
    if {"option_radar_opportunity", "option_radar_summary"}.intersection(tables):
        from investment_panel.infrastructure.postgres.option_ticket_read import reconcile_loaded_radar_tables
