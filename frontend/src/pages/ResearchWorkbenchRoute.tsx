...
export function ForecastCollection({ lane, quality }: { lane: Record<string, any>; quality: Record<string, any> }) {
  return <section className="rounded-lg border border-border bg-card p-4 text-sm" aria-label="Forecast collection lifecycle">
    ...
    <p className="mt-2 text-xs text-muted-foreground">Unresolved, unsupported and dependent claims are not scored as losses or counted as independent evidence. The settlement worker resolves recorded claims after their observation window.</p>
