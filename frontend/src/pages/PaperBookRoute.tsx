...
function PerformanceVisual({ performance, chart, points, drawdownPoints, locationSearch, onChart, onSelect, onRangeChange }: { performance: PaperPerformance; chart: string; points: Array<{ at: string; cumulative_net_pnl: number; trade_id: string }>; drawdownPoints: Array<{ at: string; drawdown: number; trade_id: string }>; locationSearch: string; onChart: (value: string) => void; onSelect: (tradeId: string) => void; onRangeChange: (from: string, to: string) => void }) {
