...
function buildTimeline(trade: PaperTrade): TimelineEvent[] {
  ...
  if (trade.mark_status === "verified" && !trade.mark_stale && trade.mark_observed_at && trade.remaining_quantity) events.push({ label: "Latest verified mark", at: trade.mark_observed_at, kind: "mark", price: trade.mark_price });
  const outcome = safeRecord(trade.outcome);
