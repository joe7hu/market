...
- `brain context`
- `brain project market`
- `brain project arco`
- `brain project birdclaw`
- `brain skill project-session`

Implementation changes happen in this repo. Durable decisions, summaries,
timelines, and cross-project lessons should be written back to the brain.
...
- API: `uv run uvicorn investment_panel.api.main:app --reload --host 0.0.0.0 --port 8010`
